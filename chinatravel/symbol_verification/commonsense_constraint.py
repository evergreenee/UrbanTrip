...
def Is_intercity_transport_correct(symbolic_input, plan_json, verbose=False):
    ...
    table_statistics = pd.DataFrame(columns=['Intercity transportation events must occur',
                                             'Invalid Trains or Airplanes, given TrainID/FlightID, origin and destination',
                                             'Incorrect Information of Intercity Transport on price or duration',
                                             'Incorrect Cost on Intercity Transportation'])
    ...
    for _, row in go_df.iterrows():
        if go_type == 'airplane':
            ...
            if go_intercity_transport_plan['FlightID'] == row['FlightID'] and go_intercity_transport_plan['start'] == \
                    row['From'] and go_intercity_transport_plan['end'] == row['To']:
                go_flag = 1
                try:
                    go_intercity_transport_plan['start_time']
                    go_intercity_transport_plan['end_time']
                    if row['BeginTime'] == go_intercity_transport_plan['start_time'] and row['EndTime'] == \
                            go_intercity_transport_plan['end_time']:
                        pass
                    else:
                        table_statistics.loc[0, "Incorrect Information of Intercity Transport on price or duration"] = 1
                        error_info.append(
                            "Incorrect duration information of given intercity airplane (Go) [start_time -> end_time].")
                except:
                    table_statistics.loc[0, "Incorrect Information of Intercity Transport on price or duration"] = 1
                ...
                try:
                    ...
                    if row['Cost'] == go_intercity_transport_plan['price']:
                        ...
                        table_statistics.loc[0, "Incorrect Information of Intercity Transport on price or duration"] = 1
                        error_info.append(
                            "Incorrect price information of given intercity airplane [origin -> destination].")
                except:
                    table_statistics.loc[0, "Incorrect Information of Intercity Transport on price or duration"] = 1
                ...
                try:
                    ...
                    if abs(go_intercity_transport_plan['price'] * go_intercity_transport_plan['tickets'] -
                           go_intercity_transport_plan['cost']) > .1:
                        table_statistics.loc[0, "Incorrect Cost on Intercity Transportation"] = 1
                        error_info.append(
                            "Incorrect cost information of given intercity airplane (Go) [cost = price * tickets].")
                except:
                    table_statistics.loc[0, "Incorrect Cost on Intercity Transportation"] = 1
        ...
        if go_type == 'train':
            ...
            if go_intercity_transport_plan['TrainID'] == row['TrainID'] and go_intercity_transport_plan['start'] == row[
                'From'] and go_intercity_transport_plan['end'] == row['To']:
                go_flag = 1
                try:
                    go_intercity_transport_plan['start_time']
                    go_intercity_transport_plan['end_time']
                    if row['BeginTime'] == go_intercity_transport_plan['start_time'] and row['EndTime'] == \
                        ...
                        table_statistics.loc[0, "Incorrect Information of Intercity Transport on price or duration"] = 1
                        error_info.append(
                            "Incorrect duration information of given intercity train (Go) [start_time -> end_time].")
                except:
                    table_statistics.loc[0, "Incorrect Information of Intercity Transport on price or duration"] = 1
                ...
                try:
                    ...
                    if row['Cost'] == go_intercity_transport_plan['price']:
                        ...
                        table_statistics.loc[0, "Incorrect Information of Intercity Transport on price or duration"] = 1
                        error_info.append(
                            "Incorrect price information of given intercity train [origin -> destination].")
                except:
                    table_statistics.loc[0, "Incorrect Information of Intercity Transport on price or duration"] = 1
                ...
                try:
                    ...
                    if abs(go_intercity_transport_plan['price'] * go_intercity_transport_plan['tickets'] -
                        ...
                        table_statistics.loc[0, "Incorrect Cost on Intercity Transportation"] = 1
                        error_info.append(
                            "Incorrect cost information of given intercity train (Go) [cost = price * tickets].")
                except:
                    table_statistics.loc[0, "Incorrect Cost on Intercity Transportation"] = 1
    ...
    for _, row in back_df.iterrows():
        if back_type == 'airplane':
            try:
                ...
                break
            if back_intercity_transport_plan['FlightID'] == row['FlightID'] and back_intercity_transport_plan[
                'start'] == row['From'] and back_intercity_transport_plan['end'] == row['To']:
                back_flag = 1
                try:
                    back_intercity_transport_plan['start_time']
                    back_intercity_transport_plan['end_time']
                    if row['BeginTime'] == back_intercity_transport_plan['start_time'] and row['EndTime'] == \
                            back_intercity_transport_plan['end_time']:
                        pass
                    else:
                        table_statistics.loc[0, "Incorrect Information of Intercity Transport on price or duration"] = 1
                        error_info.append(
                            "Incorrect duration information of given intercity airplane (Back) [start_time -> end_time].")
                except:
                    table_statistics.loc[0, "Incorrect Information of Intercity Transport on price or duration"] = 1
                ...
                try:
                    ...
                    if row['Cost'] == back_intercity_transport_plan['price']:
                        ...
                        table_statistics.loc[0, "Incorrect Information of Intercity Transport on price or duration"] = 1
                        error_info.append(
                            "Incorrect price information of given intercity airplane [destination -> origin].")
                except:
                    table_statistics.loc[0, "Incorrect Information of Intercity Transport on price or duration"] = 1
                ...
                try:
                    ...
                    if abs(back_intercity_transport_plan['price'] * back_intercity_transport_plan['tickets'] -
                           back_intercity_transport_plan['cost']) > .1:
                        table_statistics.loc[0, "Incorrect Cost on Intercity Transportation"] = 1
                        error_info.append(
                            "Incorrect cost information of given intercity airplane (Back) [cost = price * tickets].")
                except:
                    table_statistics.loc[0, "Incorrect Cost on Intercity Transportation"] = 1
        ...
        if back_type == 'train':
            ...
            if back_intercity_transport_plan['TrainID'] == row['TrainID'] and back_intercity_transport_plan['start'] == \
                    row['From'] and back_intercity_transport_plan['end'] == row['To']:
                back_flag = 1
                try:
                    back_intercity_transport_plan['start_time']
                    back_intercity_transport_plan['end_time']
                    if row['BeginTime'] == back_intercity_transport_plan['start_time'] and row['EndTime'] == \
                        ...
                        table_statistics.loc[0, "Incorrect Information of Intercity Transport on price or duration"] = 1
                        error_info.append(
                            "Incorrect time information of given intercity train [destination -> origin].")
                except:
                    table_statistics.loc[0, "Incorrect Information of Intercity Transport on price or duration"] = 1
                ...
                try:
                    ...
                    if abs(back_intercity_transport_plan['price'] * back_intercity_transport_plan['tickets'] -
                        ...
                        table_statistics.loc[0, "Incorrect Cost on Intercity Transportation"] = 1
                        error_info.append(
                            "Incorrect cost information of given intercity train (Back) [cost = price * tickets].")
                except:
                    table_statistics.loc[0, "Incorrect Cost on Intercity Transportation"] = 1
...
def Is_attractions_correct(symbolic_input, plan_json, verbose=False):
    ...
    table_statistics = pd.DataFrame(
        columns=['Unavailable attractions', 'Visiting attraction in their closed time', 'Repeated attraction Choices',
                 'Incorrect price Information of attraction', 'Incorrect cost Information of attraction'])
    ...
    for day_plan_i in plan:
        for activity_i in day_plan_i["activities"]:
            ...
            try:
                ...
                if not (time_compare_if_earlier_equal(opentime,
                                                      activity_i["start_time"]) and time_compare_if_earlier_equal(
                        activity_i["end_time"], endtime)):
                    ...
                    error_info.append(
                        "The attraction is closed now. {}, open time: [{} -- {}]".format(activity_i["position"],
                                                                                         opentime, endtime))
            except:
                table_statistics.loc[0, 'Visiting attraction in their closed time'] = 1
            ...
            try:
                ...
                if int(activity_i["price"]) != int(select_attraction["price"].values[0]):
                    ...
                    error_info.append(
                        "Incorrect price infomation of attraction [{}], price: {} ".format(activity_i["position"],
                                                                                           activity_i["price"]))
...
def Is_hotels_correct(symbolic_input, plan_json, verbose=False):
    target_city = symbolic_input["target_city"]
    table_statistics = pd.DataFrame(
        columns=['Unavailable Accommodation', 'Incorrect Information of Accommodation on price or room type',
                 'Incorrect cost Information of Accommodation',
                 'Accomondation is necessary for trips longer than one day'])
        ...
        for activity_i in day_plan_i["activities"]:
            ...
            try:
                ...
                if activity_i["price"] != select_hotel["price"].values[0]:
                    ...
                    error_info.append(
                        "Incorrect price infomation of accommodation [{}], price: {} ".format(activity_i["position"],
                                                                                              select_hotel[
                                                                                                  "price"].values[0]))
            ...
            try:
                ...
                if activity_i["room_type"] != select_hotel["numbed"].values[0]:
                    table_statistics.loc[0, 'Incorrect Information of Accommodation on price or room type'] = 1
                    error_info.append(
                        "Incorrect room infomation of accommodation [{}], numbed: {} ".format(activity_i["position"],
                                                                                              select_hotel[
                                                                                                  "numbed"].values[0]))
            except:
                table_statistics.loc[0, 'Incorrect Information of Accommodation on price or room type'] = 1
...
def Is_restaurants_correct(symbolic_input, plan_json, verbose=False):
    target_city = symbolic_input["target_city"]
    table_statistics = pd.DataFrame(
        columns=['Unavailable Restruants', 'Visiting Restruants in their closed time', 'Repeated Restruants Choices',
                 'Incorrect price Information of Restruants', 'Incorrect cost Information of Restruants',
        ...
        for activity_i in day_plan_i["activities"]:
            ...
            if activity_i["type"] == "breakfast" and select_restaurant.empty:
                ...
                try:
                    ...
                    if time_compare_if_earlier_equal("09:00",
                                                     activity_i["start_time"]) or time_compare_if_earlier_equal(
                            activity_i["end_time"], "06:00"):
                ...
                try:
                    ...
                    if abs(symbolic_input["people_number"] * activity_i["price"] - activity_i["cost"]) > .1:
                        ...
                        error_info.append(
                            "Incorrect cost information of Restruants Events [cost = price * people_number].")
                except:
                    table_statistics.loc[0, 'Incorrect cost Information of Restruants'] = 1
            ...
            try:
                ...
                if activity_i["price"] != select_restaurant["price"].values[0]:
                    table_statistics.loc[0, 'Incorrect price Information of Restruants'] = 1
                    error_info.append(
                        "Incorrect price infomation of restaurant [{}], price: {} ".format(activity_i["position"],
                                                                                           select_restaurant[
                                                                                               "price"].values[0]))
            except:
                table_statistics.loc[0, 'Incorrect price Information of Restruants'] = 1
            ...
            try:
                activity_i["start_time"]
                activity_i["end_time"]
                if activity_i["type"] == "lunch" and (time_compare_if_earlier_equal("14:00", activity_i[
                    "start_time"]) or time_compare_if_earlier_equal(activity_i["end_time"], "11:00")):
                    table_statistics.loc[0, 'Inappropriate Meal Times'] = 1
                    error_info.append("The time of lunch should be in [11:00 -- 14:00]")
                if activity_i["type"] == "dinner" and (time_compare_if_earlier_equal("20:00", activity_i[
                    "start_time"]) or time_compare_if_earlier_equal(activity_i["end_time"], "17:00")):
                    table_statistics.loc[0, 'Inappropriate Meal Times'] = 1
...
def Is_transport_correct(symbolic_input, plan_json, verbose=False):
    target_city = symbolic_input["target_city"]
    table_statistics = pd.DataFrame(columns=['Unavailable Inner-City Transport',
                                             'Incorrect Information of Inner-City Transporton on price, distance, and duration',
                                             'Inccorrect cost information of Inner-City Transport'])
        ...
        for activity_i in day_plan_i["activities"]:
            ...
            if "transports" in activity_i:
                ...
                if (len(transport_i) == 3):
                    try:
                        tools_return = innercity_transport.goto(city=target_city, start=source_poi, end=target_poi,
                                                                start_time=start_time, transport_type="metro",
                                                                verbose=False)
                    except:
                        table_statistics.loc[0] = [1, 1, 1]
                        error_info.append(
                            "GoTo error city [{}], start [{}], end [{}], start_time [{}], transport_type [metro]".format(
                                target_city, source_poi, target_poi, start_time))
                        continue
                    ...
                    for idx, trans_ii in enumerate(transport_i):
                        ...
                        try:
                            if trans_ii["start"] != tools_return[idx]["start"]:
                                ...
                                error_info.append("Incorrect infomation of transport {} -> {}".format(source_poi,
                                                                                                      target_poi) + "  [{}], Tool: [{}]".format(
                        ...
                        try:
                            ...
                            if trans_ii["start_time"] != tools_return[idx]["start_time"] or trans_ii["end_time"] != \
                                    tools_return[idx]["end_time"]:
                                table_statistics.loc[
                                    0, 'Incorrect Information of Inner-City Transporton on price, distance, and duration'] = 1
                                error_info.append(
                                    "Incorrect duration infomation of transport {} -> {}".format(source_poi,
                                                                                                 target_poi) + "  [{}], Tool: [{}]".format(
                                        trans_ii, tools_return[idx]))
                            ...
                            table_statistics.loc[
                                0, 'Incorrect Information of Inner-City Transporton on price, distance, and duration'] = 1
                            error_info.append("Incorrect duration infomation of transport {} -> {}".format(source_poi,
                                                                                                           target_poi) + "  [{}], Tool: [{}]".format(
                                trans_ii, tools_return[idx]))
                        ...
                        try:
                            ...
                            if abs(trans_ii["price"] - tools_return[idx]["cost"]) > 0.1:
                                table_statistics.loc[
                                    0, 'Incorrect Information of Inner-City Transporton on price, distance, and duration'] = 1
                                error_info.append("Incorrect price infomation of transport {} -> {}".format(source_poi,
                                                                                                            target_poi) + "  [{}], Tool: [{}]".format(
                                    trans_ii, tools_return[idx]))
                        except:
                            table_statistics.loc[
                        ...
                        try:
                            ...
                            if abs(trans_ii["distance"] - tools_return[idx]["distance"]) > 0.1:
                                table_statistics.loc[
                                    0, 'Incorrect Information of Inner-City Transporton on price, distance, and duration'] = 1
                                error_info.append(
                                    "Incorrect distance infomation of transport {} -> {}".format(source_poi,
                                                                                                 target_poi) + "  [{}], Tool: [{}]".format(
                                        trans_ii, tools_return[idx]))
                        except:
                            table_statistics.loc[
                                0, 'Incorrect Information of Inner-City Transporton on price, distance, and duration'] = 1
                            error_info.append("Incorrect distance infomation of transport {} -> {}".format(source_poi,
                                                                                                           target_poi) + "  [{}], Tool: [{}]".format(
                                trans_ii, tools_return[idx]))
                        ...
                        if trans_ii['mode'] == 'metro':
                            try:
                                ...
                                if abs(trans_ii['price'] * trans_ii['tickets'] - trans_ii['cost']) > .1:
                                    ...
                                    error_info.append(
                                        "Incorrect cost information of transport {} -> {}".format(source_poi,
                                                                                                  target_poi) + "  [{}], [cost=price*tickets] ".format(
                                            trans_ii))
                            except:
                                table_statistics.loc[0, 'Incorrect cost information of Inner-City Transport'] = 1
                                error_info.append("Incorrect cost information of transport {} -> {}".format(source_poi,
                                                                                                            target_poi) + "  [{}], [cost=price*tickets] ".format(
                                    trans_ii))
                    ...
                    try:
                        if transport_i[0]["mode"] != "walk" or transport_i[2]["mode"] != "walk" or transport_i[1][
                            "mode"] != "metro":
                            table_statistics.loc[0, 'Unavailable Inner-City Transport'] = 1
                            error_info.append(
                                "Incorrect transport type of transport {} -> {}".format(source_poi, target_poi))
                    except:
                        table_statistics.loc[0, 'Unavailable Inner-City Transport'] = 1
                        error_info.append(
                            "Incorrect transport type of transport {} -> {}".format(source_poi, target_poi))
                    ...
                    try:
                        tools_return = innercity_transport.goto(city=target_city, start=source_poi, end=target_poi,
                                                                ...
                                                                transport_type=transport_i[0]["mode"], verbose=False)
                        if not isinstance(tools_return, list):
                            table_statistics.loc[0] = [1, 1, 1]
                            error_info.append(
                                "Can not find a path of transport {} -> {}".format(source_poi, target_poi))
                    except:
                        table_statistics.loc[0] = [1, 1, 1]
                        error_info.append(
                            "GoTo error city [{}], start [{}], end [{}], start_time [{}], transport_type [metro]".format(
                        ...
                        if trans_ii['mode'] == 'walk':
                            ...
                            try:
                                ...
                                if abs(trans_ii['price'] * trans_ii['cars'] - trans_ii['cost']) > .1:
                                    ...
                                    error_info.append(
                                        "Incorrect cost information of transport {} -> {}".format(source_poi,
                                                                                                  target_poi) + "  [{}], [cost=price*cars] ".format(
                                            trans_ii))
                            except:
                                table_statistics.loc[0, 'Incorrect cost information of Inner-City Transport'] = 1
                                error_info.append("Incorrect cost information of transport {} -> {}".format(source_poi,
...
def Is_time_correct(symbolic_input, plan_json, verbose=False):
    ...
    table_statistics = pd.DataFrame(
        columns=['Invalid duration information of each activity', 'Does not follow Chronological Order'])
    ...
    for day_plan_i in plan:
        for activity_i in day_plan_i["activities"]:
            ...
            # print(activity_i)
            try:
                activity_i["start_time"] and activity_i["end_time"]
            except:
            ...
            not activity_i["type"] in ["train", "airplane"]):  # 可能出现次日到达
        ...
        for activity_i in day_plan_i["activities"]:
            ...
            if (len(position_list) > 0) and position_i != position_list[-1]:
                ...
                if not "transports" in activity_i:
                    table_statistics.loc[0, 'Invalid Transport information across positions'] = 1
                    error_info.append(
                        "There must be transport between activities in different possitions: " + str(activity_i))
                    # continue
                    ...
                    if activity_i["transports"][0]["start"] != position_list[-1]:
                        table_statistics.loc[0, 'Invalid Transport information across positions'] = 1
                        error_info.append(
                            "The origin of the transport must be equal to the position of the previous activity.: " + str(
                                activity_i))
                        # continue
                    ...
                    if activity_i["transports"][-1]["end"] != position_i:
                        table_statistics.loc[0, 'Invalid Transport information across positions'] = 1
                        error_info.append(
                            "The destination of the transport must be equal to the position of the current activity.: " + str(
                                activity_i))
                        # continue
...
def func_commonsense_constraints(symbolic_input, plan_json, verbose=False):
    func_list = [Is_intercity_transport_correct, Is_attractions_correct, Is_hotels_correct, Is_restaurants_correct,
